...
**Exercise 1.2**: Add a new column `month` (consisting of two levels) to `d` in which `loc` and `day` are nested and reshape to wide format and back to long format. The long format is what we commonly use in statistics.
